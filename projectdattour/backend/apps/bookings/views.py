...
# --- Bổ sung BookingCreateView cho test ---
class BookingCreateView(CreateView):
    model = Booking
    fields = ['tour', 'user', 'adults', 'children', 'tour_date']  # Thay bằng các trường phù hợp với model Booking
    template_name = 'bookings/booking_form.html'
    success_url = '/bookings/history/'
